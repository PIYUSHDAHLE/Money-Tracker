...
const supportCards = [
  {
    ...
    image:
      "/images/money-tracker-by-piyush-dahle-support-center-knowledge-base-image.png",
  },
  {
    title: "AI Assistant",
    desc: "Get instant answers to common questions like setting up categories, managing subscriptions, and generating reports.",
    image:
      "/images/money-tracker-by-piyush-dahle-support-center-ai-assistant-image.png",
  },
  {
    title: "Support Request",
    desc: "Need more help? Submit a support request and our team will assist you with Money Tracker issues.",
    image:
      "/images/money-tracker-by-piyush-dahle-support-center-support-request-image.png",
  },
];
...
export default function SupportCenter() {
  ...
  return (
    <>
      <Helmet>
        <title>Support Center | Money Tracker</title>
        <meta name="title" content="Support Center | Money Tracker" />
        <meta
          name="description"
          content="Browse FAQs, find solutions, and get help with using Money Tracker effectively."
        />
      </Helmet>
      <div
        ref={pageRef}
        ...
        <section className=" md:px-23 grid grid-cols-1 lg:grid-cols-2 gap-8 mt-16 items-start py-20">
          ...
          <div>
            ...
            <Accordion variant="splitted">
              ...
              >
                Go to the dashboard, click on{" "}
                <b className="text-blue-500">Add Transaction</b>, enter the
                details, and save.
              </AccordionItem>
              <AccordionItem
                key="2"
              ...
              <AccordionItem
                ...
                className="text-gray-600 dark:text-gray-400"
              >
                Reports are available in the Reports tab, where you can filter
                by date, category, or account.
              </AccordionItem>
              <AccordionItem
                className="text-gray-600 dark:text-gray-400"
                key="4"
              ...
              >
                Absolutely. Money Tracker uses end-to-end encryption to keep
                your data safe.
              </AccordionItem>
            </Accordion>
          </div>

...
export default function ResetPassword() {
  ...
  return (
    <>
      <Helmet>
        <title>Reset Password | Money Tracker</title>
                <meta name="title" content="Reset Password | Money Tracker" />
        <meta
          name="description"
          content="Securely reset your password and continue tracking your money without interruptions."
        />
      </Helmet>

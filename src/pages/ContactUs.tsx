        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-el space-y-6">
            ...
            <p className="opacity-80">
              Our team is here to help you with any inquiries or support you may
              need. Fill out the form and we’ll get back to you shortly.
            </p>
          </div>
      ...
      >
        ...
        <div className="animate-el flex flex-wrap justify-center gap-8">
          <div className="flex items-center gap-3">
            <Phone className="w-6 h-6 text-yellow-400" /> <span>+91 98765 43210</span>
          </div>
          <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            <MapPin className="w-6 h-6 text-yellow-400" /> <span>Pune, India</span>
          </div>
        </div>
